...
<div style={{
  ...
  <div style={{
    ...
    <img src={github?.user?.avatarUrl ?? 'https://github.com/Pushkar026.png'} width={88} height={88} style={{ borderRadius: 44 }} />
  </div>
  ...
  <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
    ...
    <div style={{ display:'flex', gap:8, marginTop:6, flexWrap: 'wrap' }}>
      {((github && github.languages && github.languages.length > 0)
        ...
        : ['readme-aura'], ['MERN Stack', 'TypeScript', 'Socket.io', 'FastAPI']
      ).map(function(tag, i) {
        return (
          <div key={tag + '-' + i} style={{
...
```aura width=860 height=22 link="https://collectioneur.github.io/readme-aura/"
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', padding: 0, margin: 0 }}>
    <span style={{ fontSize: 12, lineHeight: 1, color: 'rgba(150,140,200,0.55)', fontWeight: 500, letterSpacing: '0.4px' }}></span>
  </div>
```
